...
public class FormatoPDF {
	...
	private List<Formato> listas;

	public FormatoPDF(List<Formato> listas) {
		super();
		this.listas = listas;
	}
	...
	private void escribirDatosDeLaTabla(PdfPTable tabla) {
		for (Formato list : listas) {
			tabla.addCell(String.valueOf(list.getId_formato()));
			tabla.addCell(list.getFormato());
			if(list.isEstado()) {
	...
	public void exportar(HttpServletResponse response) throws DocumentException, IOException {
		...
		Paragraph titulo = new Paragraph("LISTADO DE FORMATOS", fuente);
